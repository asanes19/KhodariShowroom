        ...
        <main class="main">
            <section class="form-section section">
                <div class="form-container">
                    <h2 class="form-header">إضافة مستخدم جديد</h2>
                    <form class="user-form" method="POST" action="scripts/add_user.php">
                        ...
                        <div class="form-group">
                            <button type="submit" style="width: 80px;" name="addNewUser" class="btn myBtn">إضافة</button>
                        </div>
                    </form>
                </div>
            </section>
