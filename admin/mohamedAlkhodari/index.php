...
include('scripts/totalCarsScript.php');
?>
<!DOCTYPE html>
<html lang="ar">
    <head>
                ...
                <section>
                    <div class="mainCont">
                        <div class="threeConts">
                            <div class="miniCont addCar">
                                <a class="alink" href="addNewCar.php">
                                    <i class="fas fa-plus"></i>
                                    <h4>اضافة سيارة جديدة</h4>
                                </a>
                            </div>

                            <div class="miniCont viewCars">
                                <a class="alink" href="carsList.php">
                                    <i class="fas fa-car"></i>
                                    <h4>عرض السيارات</h4>
                                </a>
                            </div>
                            <div class="miniCont totalCars">
                                <i class="fas fa-car-alt"></i>
                                <h4>إجمالي السيارات</h4>
                                <h2 style="color: var(--clr-neon);"><?php echo $totalCars; ?></h2>
                            </div>
                        </div>
